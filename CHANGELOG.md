...
- Fixed mounted-file read history showing `bytes=...` as the task path. It now shows the remote file path with the exact requested byte range as supporting detail across desktop and Web task projections.
